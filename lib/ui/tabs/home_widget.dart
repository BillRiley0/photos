...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  void initState() {
    ...
    // OFFLINE MODE: Deep links skipped
    // _initDeepLinks();
    // OFFLINE MODE: Update notification skipped

    // OFFLINE MODE: Deep link subscriptions skipped
    ...
    // OFFLINE MODE: In-app link permissions skipped
    if (false) { // was: Platform.isAndroid && ... RemoteSyncService ...
    ...
    // OFFLINE MODE: MemoryShareService skipped
  }
                  ...
                  builder: (context, selectedTabIndex, _) {
                    return ExtentsPageView(
                      ...
                      children: [
                        ...
                        // OFFLINE MODE: Feed tab replaced with empty placeholder
                        _buildTabHeroMode(
                          2,
                          selectedTabIndex,
